...
const AdminSidebar = () => {
  ...
  return (
    ...
    >
      <Typography sx={{mt:'30px'}} variant="h5">Panel de administración</Typography>
      <StyledButton onClick={handleAdmin} value='users/' sx={{mt:'40px'}}>Administrar usuarios</StyledButton>
      <StyledButton onClick={handleAdmin} value='orders/'>Historial de compras</StyledButton>
