            ...
            <TabContext value={value}>
              ...
              <TabPanel value="2">
                ...
                >
                  <Box padding={2}>
                    ...
                    <Typography>
                      <strong>Procesadores:</strong> Cantidad:{" "}
                      {product.processor}
                    </Typography>
                    <Typography>
              ...
              <TabPanel value="3">
                ...
                >
                  ...
                  AGOTAR STOCK LO QUE SUCEDA PRIMERO EN TERMINALES
                  SELECCIONADOS. ORIGEN: ARGENTINA. PRECIOS PARA CONSUMIDOR
                  FINAL IVA INCLUIDO. EL PRECIO FINAL CON EL DESCUENTO APLICADO
                  SE VERÁ REFLEJADO ANTES DE CONFIRMAR EL PAGO. FINANCIACIÓN: 6
                  CUOTAS SIN INTERÉS EN LA COMPRA DE EQUIPOS ABONANDO CON
                  TARJETAS DE CRÉDITO VISA, MASTERCARD, AMERICAN EXPRESS Y
                  CABAL, EMITIDAS EN ARGENTINA. COSTO FINANCIERO TOTAL (C.F.T.):
                  0%; TASA NOMINAL ANUAL (T.N.A.): 0%; TASA EFECTIVA ANUAL
                  (T.E.A.) 0%. PINEAPPLE ARGENTINA S.A.
                </Typography>
              </TabPanel>
            </TabContext>
          </Box>
